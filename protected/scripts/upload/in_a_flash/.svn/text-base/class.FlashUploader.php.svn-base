	...
	*********************************************************************************************/
	class FlashUploader {
		...
		*********************************************************************************************/
		function FlashUploader($element_id, $swf_path, $target) {
			...
			$this->properties	= array(
									...
									'set_width'		=> 310,
									'set_height'		=> 54,
									'valid_extensions'	=> '*.avi,*.flv,*.mov,*.mp4,*.mts,*.pdf,*.wmv',
									'extensions_mod'	=> '*.avi;*.flv;*.mov;*.mp4;*.mts;*.pdf;*.wmv',
									'bar_bg_color' 		=> '0x00CC00',
									'divider_color'		=> '0x00AA00',
									'txt_title_color'	=> '0xCC0000',
									'txt_filename_color'	=> '0x000000',
									'txt_percent_color'	=> '0x000000',
									'txt_progress_color'	=> '0x000000',
									'button_color'		=> '0x555544',
									'button_shadow'		=> '0xCC0000',
									'button_title_color'	=> '0xFFFFFF',
									'max_file_size'		=> '80000',
									'max_files'		=> '10',
									'auto-clear'		=> '1',									
									'allow_clear'		=> '1',
									'allow_cancel'		=> '1',
									'click_text'		=> 'Click here to upload a file',
									'complete_text'		=> 'Upload complete',
									);
		...
		*********************************************************************************************/
		function display() {
			ob_start(); ?>
			<div id="<?php echo $this->element_id?>" style="position:absolute;top:-18px;width: <?php echo $this->properties['set_width']?>px; height: <?php echo $this->properties['set_height']?>px;">
