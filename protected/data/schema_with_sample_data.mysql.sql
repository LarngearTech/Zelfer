...
--
-- Host: localhost
-- Generation Time: Jan 28, 2013 at 03:10 PM
...
(4, 'การวิเคราะห์ประสิทธิภาพอัลกอริทึม', 1, 4, -1, 0),
(5, 'สัญกรณ์โอใหญ่', 1, 5, 4, 2),
(6, 'อัตราการเติบโตของฟังก์ชัน', 1, 6, 4, 1),
(7, 'โครงสร้างข้อมูลพื้นฐาน', 1, 7, -1, 0),
(8, 'อาเรย์และรายการเชื่อมโยง', 1, 8, 7, 1),
(9, 'การเรียงลำดับและการค้นข้อมูล', 1, 9, 7, 1),
(10, 'ลำดับย่อยร่วมกันที่ยาวที่สุด', 1, 11, 11, 1),
(11, 'ไดนามิกโปรแกรมมิ่ง', 1, 10, -1, 0),
(12, 'ทดสอบ', 2, 1, 13, 2),
(13, 'Untitled Chapter', 2, 0, -1, 0),
(42, 'Quiz', 1, 3, 1, 3),
(39, 'Untitled Question', 1, 0, 14, 4),
(41, 'Untitled Question', 1, 0, 40, 4),
(48, 'qqq', 1, 0, 42, 4),
(49, 'q2', 1, 1, 42, 4),
(51, 'q3', 1, 2, 42, 4),
(52, 'q4', 1, 3, 42, 4),
...
(3, 'system@zelfer.com', '$2a$08$hQQfmgTMYKS9UHRiRzDa7.6SyAozbGIJcc9Uhy8IqcEkvVZOXgpiq', 'System Administrator', 'default.gif', '', '', 3, 1);
...
--
-- Dumping data for table `user_subgroup`
--

INSERT INTO `user_subgroup` (`id`, `group`, `name`) VALUES
(1, 1, 'ห้อง 1'),
(2, 1, 'ห้อง 2'),
(3, 1, 'ห้อง 3'),
(4, 1, 'ห้อง 4'),
